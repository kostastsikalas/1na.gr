          ...
          <div className="px-5 lg:px-8">
            <div className="flex items-center justify-between h-[68px]">
              ...
              <div className="hidden lg:flex items-center gap-1.5 ml-2 border-l border-gray-200 pl-4">
                ...
                <a href="https://www.tiktok.com/@frontistrioena?_r=1&_t=ZN-99E7weZxdTS" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center rounded-xl text-[#213576]/70 hover:bg-[#213576]/10 hover:text-[#213576] transition-all">
                  <TikTokIcon size={18} />
                </a>
        ...
        >
          <div className="p-4 space-y-1">
            ...
            <div className="pt-4 pb-2 border-t border-gray-100 mt-2 flex items-center justify-center gap-4">
              ...
              <a href="https://www.tiktok.com/@frontistrioena?_r=1&_t=ZN-99E7weZxdTS" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#213576]/5 text-[#213576] hover:bg-[#213576]/10 transition-colors">
                <TikTokIcon size={20} />
              </a>
